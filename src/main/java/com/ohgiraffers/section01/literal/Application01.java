...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        /* 목차 2. 문자 형태의 값 출력 */
        System.out.println('a');        // 문자 형태의 값은 홀따옴표로 감싸준다
//        System.out.println('ab');     // 두 개 이상은 문자로 취급하지 않기 때문에 에러 발생
//        System.out.println('');       // 아무 문자도 기록되지 않는 경우로 에러가 발생한다.
        System.out.println('1');        // 숫자 값 이지만 홀따옴표로 감싸져 있는 경우는 문자 '1' 이라고 판단한다

        /*목차. 3 문자열의 형태의 값 출력 */
        System.out.println("안녕하세요");        // 문자열은 문자 여러개가 나열된 형태를 말하며 쌍따옴표로 감싸주어야한다.
